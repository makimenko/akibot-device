...
var pinForGyro = pin_base + 1;

console.log("on...");
wpi.pinMode(pinForGyro, 1);
wpi.digitalWrite(pinForGyro, 1);

wpi.delay(2000);

//console.log("off...");
//wpi.digitalWrite(pinForGyro, 0);
//wpi.delay(2000);
...
// Source:
// https://github.com/nkolban/hmc5883l-pi/blob/master/src/hmc5883l-pi.js
